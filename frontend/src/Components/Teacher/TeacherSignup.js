...
export default function TeacherSignup  ({ navigation })  {
  ...
  const sendToBackend = () => {
    if (
      ...
      fetch('http://192.168.43.226:5000/api/teacher/createAccount', {
        method: 'POST',
    ...
    <Text>{'\n'}{'\n'}{'\n'}{'\n'}</Text>
      ...
      {/* <Text> TEACHER SIGNUP</Text>    */}
          ...
          <TextInput
            label="Employment ID"
            onChangeText={(number) =>
            setFormData({ ...formData, RegisterNumber: number })
            }
          />
          <TextInput
            label="Password"
  ...
  <Text style={styles.optionText}>Gender :</Text>
    ...
    <View style={styles.radioButtonContainer}>
      ...
      <View style={styles.row}>
        ...
        <TouchableOpacity onPress={() => navigation.replace('Teacher Login')}>
